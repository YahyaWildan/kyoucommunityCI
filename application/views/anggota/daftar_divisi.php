          ...
          <div class="row">
            <div class="col-lg-12">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                <form action="<?php echo base_url()."index.php/dashboardanggota/proses_daftar_divisi/".$this->session->userdata('id_anggota') ?>" method="POST">
                    Divisi<br>
                    <select name="divisi" id="divisi"  class="form-control"> 
                    <?php
                      foreach($data as $da){
                    ?>
                        <option value="<?php echo $da['id_divisi'];?>"><?php echo $da['nama'];?></option>
                    <?php
                        }
                    ?>
                    </select>
