            ...
            <div class="col-lg-12">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Selamat Datang Anggota Kyoucommunity 🤝</h6>
                </div>
                <div class="card-body">
                  <p>Hello 🖐</p>
                  <p class="mb-0">Bagi kamu yang ingin bergabung dengan kita untuk menolong saudara - saudara kita yang sedang menghadapi musibah , yuk gabung sama Kita Bantu agar saudara-saudara kita yang kesusahan dapat berkurang bebannya ❣ </p>
                </div>
              </div>
