          ...
          <div class="row">
            <div class="col-lg-12">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                <form action="<?php echo base_url()."index.php/dashboardanggota/proses_edit_profil/".$this->session->userdata('id_anggota'); ?>" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="id_anggota" value="<?php echo $id_anggota; ?>"><br>
                    Nama Lengkap : <br>
                    <input type="text" name="nama_lengkap" value="<?php echo $nama_lengkap; ?>" class="form-control"><br><br>
                    Username : <br>
                    <input type="text" name="username" value="<?php echo $username; ?>" class="form-control"><br><br>
                    Email : <br>
                    <?php echo $email; ?><br><br>
                    Tempat Lahir : <br>
                    <input type="text" name="tempat_lahir" value="<?php echo $tempat_lahir; ?>" class="form-control"><br><br>
                    Tanggal Lahir : <br>
                    <input type="text" name="tanggal_lahir" value="<?php echo $tanggal_lahir; ?>" class="form-control"> Format : YYY-BB-HH<br><br>
                    Alamat : <br>
                    <textarea name="alamat" class="form-control"><?php echo $alamat;?> </textarea><br><br>
                    Nomor Handphone : <br>
                    <input type="text" name="no_hp" value="<?php echo $no_hp; ?>" class="form-control"><br><br>
                    Foto : <br>
                    <img src="<?php echo base_url().$foto;?>"><br>
                    <input type="file" name="foto" class="form-control"><br><br>

                    <input type="submit" value="Edit" class="btn-primary form-control">
